...
mvn compile
mvn exec:java -Dexec.mainClass="com.krishna.krishnamart.util.DbSeeder"
mvn clean package
cp target/krishnamart.war $CATALINA_HOME/webapps/
```
...
| Role | Email | Password |
|---|---|---|
| Admin | admin@krishnamart.com | Admin@12345 |
| Seller | priya.seller@krishnamart.com | Seller@123 |
| Seller | arjun.seller@krishnamart.com | Seller@123 |
| Buyer | divya.buyer@krishnamart.com | Buyer@1234 |
| Buyer | karthik.buyer@krishnamart.com | Buyer@1234 |
...
- `gemini` - calls the Gemini API server-side using `ai.chatbot.apiKey`
  (never exposed to the browser). See `com.krishna.krishnamart.chat.GeminiChatProvider`.
